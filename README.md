...
## How to add new tokens to 3xcalibur (extended) token list
...
- Add new tokens to `src/tokens/3xcalibur-extended.json` file
...
```shell script
# Fetch the Top100 Tokens on 3xcalibur v2, and update list.
$ yarn fetch:pcs-top-100

# Build token list (3xcalibur-top-100.json)
